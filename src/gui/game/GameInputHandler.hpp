...
public:
    ...
    GameInputResult handleEvent(const sf::Event& event, Game& game, Color playerColor, Color displayColor, InputMode mode);
...
private:
    GameInputResult mouseClickEvent(const sf::Event::MouseButtonPressed& event, Game& game, Color playerColor, Color displayColor, InputMode mode);
    GameInputResult mouseMovementEvent(const sf::Event::MouseMoved& event);
    GameInputResult mouseUnclickEvent(const sf::Event::MouseButtonReleased& event, Game& game, Color displayColor, InputMode mode);
    GameInputResult leftClickEvent(const sf::Event::MouseButtonPressed& event, Game& game, Color playerColor, Color displayColor, InputMode mode);
