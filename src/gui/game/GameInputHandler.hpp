...
public:
    ...
    GameInputResult
    handleEvent(const sf::Event& event, Game& game, Color playerColor, Color displayColor, InputMode mode);
...
private:
    ...
    GameInputResult
    mouseUnclickEvent(const sf::Event::MouseButtonReleased& event, Game& game, Color displayColor, InputMode mode);
